...
namespace PCRLLogbook
{
    public class Config
    {
        ...
        public Dictionary<string, string> feed_in_feeders { get; set; }
		
        public Dictionary<string, Dictionary<string, string>> feed_data { get; set; }
        public Dictionary<string, Dictionary<string, double>> supp_feed_templates { get; set; }
